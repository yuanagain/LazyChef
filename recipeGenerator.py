...
def createTask(task_name, time_delta, dependencies, description):
	task_dict = dict()
	task_dict['task_name'] = task_name
	task_dict['time_array'] = time_delta
...
def main():
	...
	print("Enter completion Time in seconds:")
	time_delta = int(sys.stdin.readline())
